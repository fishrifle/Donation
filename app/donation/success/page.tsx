...
function SuccessContent() {
  ...
  const containerRef = useHeightMonitor([amt, monthly, nextBilling]);
  ...
  return (
     <main ref={containerRef} className="min-h-screen flex flex-col justify-center items-center bg-white relative overflow-hidden">
