...
export default function SuccessClient() {
  ...
  useEffect(() => {
    ...
    if (monthly) {
      ...
      const { locale } = getLocale(navigator.language || "en-US");
      setNextBilling(
        format(nextDate, "d MMMM yyyy", { locale: (locale as Locale) || enUS })
      );
    }
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg text-center z-10">
        ...
        {monthly && (
          <p className="text-gray-700 text-sm mb-2">
            This is a <strong>monthly recurring donation</strong>. Your next
            charge will be on <strong>{nextBilling}</strong>
          </p>
        )}
